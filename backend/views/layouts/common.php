            ...
            <section class="sidebar">
                ...
                <?php echo Menu::widget([
                    ...
                    'items'=>[
                        ...
                        [
                            'label'=>Yii::t('backend', 'Content in Database'),
                            'url' => '#',
                            'icon'=>'<i class="fa fa-database"></i>',
                            'options'=>['class'=>'treeview'],
                            'items'=>[
                                ['label'=>Yii::t('backend', 'Main Categories'), 'url'=>['/main-category/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                ['label'=>Yii::t('backend', 'Brands'), 'url'=>['/brands/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                ['label'=>Yii::t('backend', 'Category'), 'url'=>['/category/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                //['label'=>Yii::t('backend', 'Service'), 'url'=>['/service/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                ['label'=>Yii::t('backend', 'Category-Brands'), 'url'=>['/category-brands/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                //['label'=>Yii::t('backend', 'Category-Service'), 'url'=>['/category-service/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                ['label'=>Yii::t('backend', 'Firms'), 'url'=>['/firms/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                ['label'=>Yii::t('backend', 'Models'), 'url'=>['/models/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                            ]
                        ],
                        [
