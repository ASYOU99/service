...
class FirmsSearch extends Firms
{
    ...
    public function rules()
    {
        return [
            ...
            [['name','site','title','description','tel', 'info', 'work_time', 'thumbnail_base_url', 'thumbnail_path', 'adress', 'metro', 'google_maps', 'name_morphy'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'name', $this->name])
            ...
            ->andFilterWhere(['like', 'name_morphy', $this->name_morphy]);
