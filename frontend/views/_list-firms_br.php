    ...
    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
        <div class="clearfix">
            <div id="found-count" class="pull-left">
                ...
                Найдено <?php use yii\widgets\LinkPager;
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-9">
                                    <div class="title clearfix">
                                        <div class="h4"><a
                                                href="<?= \yii\helpers\Url::to(['firms/view', 'id' => $firm->id], 'https') ?>"><?php echo $firm->name ?></a>
                                        </div>
                                    </div>
                                    <?php
                                    ...
                                    //  <ul class="list-inline sub-features hidden-xs">
                                    //  <li><a href=""><i
                                    //  class="fa fa-comment icon-left"></i>24 отзыва</a></li>
                                    //   <li><a href=""><i
                                    //   class="fa fa-camera icon-left"></i>7 фото</a></li>
                                    //  </ul>
                                    ?>
                                    ...
                                    <div class="text-right">
                                        <?php if ($firm->thumbnail_path): ?>
                                            <?php echo \yii\helpers\Html::img($firm->thumbnail_base_url.'/'.$firm->thumbnail_path,
                                                ['class' => 'logo img-responsive', 'alt' => $firm->name . " в Москве"]
                                            ) ?>
                                        <?php endif; ?>
                                    </div>
                                </div>
...
<!--                                                </div>-->
                        ...
                        <div class="open-phone">
                            <a href="tel:<?php echo $firm->tel; ?>" class="phone btn btn-primary btn-lg "
                            ><i class="fa fa-phone"></i><?php echo $firm->tel; ?></a>
                        </div>
                        <?php
